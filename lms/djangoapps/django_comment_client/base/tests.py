...
class SegmentIOForumThreadViewedEventTestCase(SegmentIOTrackingTestCaseBase):
    ...
    def _raise_navigation_event(self, label):
    ...
    def test_thread_viewed_event(self):
        ...
        """
        self._raise_navigation_event('Forum: View Thread')
    ...
    def test_non_thread_viewed_event(self):
        ...
        """
        self._raise_navigation_event(label='Forum: Create Thread')
...
class ForumThreadViewedEventTransformerTestCase(ForumsEnableMixin, UrlResetMixin, ModuleStoreTestCase):
    ...
    def test_categories(self):
        ...
        self.assertEqual(event_trans_2['event'].get('category_id'), self.CATEGORY_ID)
        full_category_name = '{0} / {1}'.format(self.PARENT_CATEGORY_NAME, self.CATEGORY_NAME)
